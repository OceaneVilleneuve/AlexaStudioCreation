...
namespace ScssPhpRBE\ScssPhp;

use ScssPhpRBE\ScssPhp\Base\Range;
use ScssPhpRBE\ScssPhp\Block\AtRootBlock;
use ScssPhpRBE\ScssPhp\Block\CallableBlock;
use ScssPhpRBE\ScssPhp\Block\DirectiveBlock;
use ScssPhpRBE\ScssPhp\Block\EachBlock;
use ScssPhpRBE\ScssPhp\Block\ElseBlock;
use ScssPhpRBE\ScssPhp\Block\ElseifBlock;
use ScssPhpRBE\ScssPhp\Block\ForBlock;
use ScssPhpRBE\ScssPhp\Block\IfBlock;
use ScssPhpRBE\ScssPhp\Block\MediaBlock;
use ScssPhpRBE\ScssPhp\Block\NestedPropertyBlock;
use ScssPhpRBE\ScssPhp\Block\WhileBlock;
use ScssPhpRBE\ScssPhp\Compiler\CachedResult;
use ScssPhpRBE\ScssPhp\Compiler\Environment;
use ScssPhpRBE\ScssPhp\Exception\CompilerException;
use ScssPhpRBE\ScssPhp\Exception\ParserException;
use ScssPhpRBE\ScssPhp\Exception\SassException;
use ScssPhpRBE\ScssPhp\Exception\SassScriptException;
use ScssPhpRBE\ScssPhp\Formatter\Compressed;
use ScssPhpRBE\ScssPhp\Formatter\Expanded;
use ScssPhpRBE\ScssPhp\Formatter\OutputBlock;
use ScssPhpRBE\ScssPhp\Logger\LoggerInterface;
use ScssPhpRBE\ScssPhp\Logger\StreamLogger;
use ScssPhpRBE\ScssPhp\Node\Number;
use ScssPhpRBE\ScssPhp\SourceMap\SourceMapGenerator;
use ScssPhpRBE\ScssPhp\Util\Path;
...
final class Compiler
{
    ...
    private function parserFactory(?string $path): Parser
    {
        ...
        if(  $this->cache!==null && !is_a($this->cache, 'ScssPhpRBE\ScssPhp\Cache')){            
            /* TODO fix this check - for other plugin legacy */
            $this->cache=null;
        }
    ...
    public function addVariables(array $variables): void
    {
        foreach ($variables as $name => $value) {
            if (!$value instanceof Number && !\is_array($value)) {
                throw new \InvalidArgumentException('Passing raw values to as custom variables to the Compiler is not supported anymore. Use "\ScssPhpRBE\ScssPhp\ValueConverter::parseValue" or "\ScssPhpRBE\ScssPhp\ValueConverter::fromPhp" to convert them instead.');
            }
...
will be an error in future versions of Sass.\n         on line $line of $fname";
     ...
     * @return array
     *
     * @throws \ScssPhpRBE\ScssPhp\Exception\CompilerException
     */
